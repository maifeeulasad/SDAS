...
class ClassroomRemoveServiceImpl(
    context: Context?,
    ...
    fun removeUsername(classroomId: Long, username: String) {
        val call = service.removeUsername(classroomId, username)
    ...
    fun removeUserId(classroomId: Long, userId: Long) {
        val call = service.removeUserId(classroomId, userId)
    ...
    companion object {
        var TASK_ID = ClassroomRemoveServiceImpl::class.java.name.hashCode()
    }
}